(function () {
  ...
  ; function E(a) {
    this.type = ""; this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.shiftKey = this.ctrlKey = this.altKey = !1; this.clientY = this.clientX = 0; if (a = a || window.event) {
      this.a = a; for (var b in a) b in Fa || (this[b] = a[b]); (b = a.target || a.srcElement) && 3 == b.nodeType && (b = b.parentNode); this.target = b; if (b = a.relatedTarget) try { b = b.nodeName ? b : null } catch (c) { b = null } else "mouseover" == this.type ? b = a.fromElement : "mouseout" == this.type && (b = a.toElement); this.relatedTarget =
  ...
  ; var Ia = Array.prototype.indexOf ? function (a, b, c) { return Array.prototype.indexOf.call(a, b, c) } : function (a, b, c) {
    c = null == c ? 0 : 0 > c ? Math.max(0, a.length + c) : c;
    if (x(a)) return x(b) && 1 == b.length ? a.indexOf(b, c) : -1; for (; c < a.length; c++)if (c in a && a[c] === b) return c; return -1
  }, I = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c) } : function (a, b, c) { for (var d = a.length, e = x(a) ? a.split("") : a, f = 0; f < d; f++)f in e && b.call(c, e[f], f, a) };
  ...
  var Ua;
  function Va() {
    var a = t.MessageChannel; "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !H("Presto") && (a = function () {
      var a = document.createElement("IFRAME"); a.style.display = "none"; a.src = ""; document.documentElement.appendChild(a); var b = a.contentWindow, a = b.document; a.open(); a.write(""); a.close(); var c = "callImmediate" + Math.random(), d = "file:" == b.location.protocol ? "*" : b.location.protocol + "//" + b.location.host, a = z(function (a) {
  ...
  function Wa(a) {
    if (a instanceof K) return a; if ("function" == typeof a.o) return a.o(!1); if (w(a)) {
      var b = 0, c = new K; c.next = function () { for (; ;) { if (b >= a.length) throw J; if (b in a) return a[b++]; b++ } };
      return c
  ...
  function Ya(a) {
    if (w(a)) return La(a); a = Wa(a); var b = []; Xa(a, function (a) { b.push(a) });
    return b
  }
  ...
  var db; a: {
    var eb = "", fb = function () { var a = G; if (ab) return /rv\:([^\);]+)(\)|;)/.exec(a); if ($a) return /Edge\/([\d\.]+)/.exec(a); if (L) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (bb) return /WebKit\/(\S+)/.exec(a); if (Za) return /(?:Version)[ \/]?(\S+)/.exec(a) }();
    fb && (eb = fb ? fb[1] : ""); if (L) { var gb = cb(); if (null != gb && gb > parseFloat(eb)) { db = String(gb); break a } } db = eb
  } var hb = db, na = {};
  ...
  var M; function mb() {
    var a = t.Promise; if (-1 != String(a).indexOf("[native code]")) { var b = a.resolve(void 0); M = function () { b.then(pb) } } else M = function () {
      var a = pb;
  ...
  g.o = function (a) {
    var b = 0, c = this.a, d = new K; d.next = function () { if (b >= c.length) throw J; var d = c.key(b++); if (a) return d; d = c.getItem(d); if (!x(d)) throw "Storage mechanism: Invalid value was encountered"; return d };
    return d
  };
  ...
  B(zb, P); var Ab = u("yt.dom.getNextId_"); if (!Ab) {
    Ab = function () { return ++Bb };
    A("yt.dom.getNextId_", Ab); var Bb = 0
  }; var Q = {}, Cb = [], O = new N, Db = {}; function Eb() { I(Cb, function (a) { a() }) }
  ...
  function Jb(a, b, c) {
    if (a && (a.addEventListener || a.attachEvent)) {
      var d = Ib(a, b, c); if (!d) {
        var d = ++Hb.count + "", e = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document), f; f = e ? function (d) { d = new E(d); if (!ub(d.relatedTarget, function (b) { return b == a })) return d.currentTarget = a, d.type = b, c.call(a, d) } : function (b) {
          b = new E(b);
  ...
  ; xb(new yb); xb(new zb); function S(a, b, c) {
    this.b = b; this.h = this.a = null; this.g = this[y] || (this[y] = ++ea); this.c = 0; this.B = !1; this.w = []; this.f = null; this.m = c; this.v = {}; b = document; if (a = x(a) ? b.getElementById(a) : a) if ("iframe" != a.tagName.toLowerCase() && (b = Lb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[y] || (b[y] = ++ea), a.id = "widget" + b), Q[this.a.id] = this, window.postMessage) {
      this.f = new N; Mb(this); a = T(this.b, "events"); for (var d in a) a.hasOwnProperty(d) && this.addEventListener(d, a[d]); for (var e in Db) Nb(this,
        e)
    }
  }
  ...
  function Lb(a, b) {
    for (var c = document.createElement("iframe"), d = b.attributes, e = 0, f = d.length; e < f; e++) { var h = d[e].value; null != h && "" != h && "null" != h && c.setAttribute(d[e].name, h) } c.setAttribute("frameBorder", 0); c.setAttribute("allowfullscreen", 1); c.setAttribute("title", "YouTube " + T(a.b, "title")); (d = T(a.b, "width")) && c.setAttribute("width", d); (d = T(a.b, "height")) && c.setAttribute("height", d); var l = a.s(); l.enablejsapi = window.postMessage ? 1 : 0; window.location.host && (l.origin = window.location.protocol + "//" + window.location.host);
  ...
  function Wb(a, b) {
    I(b, function (a) {
      this[a] || ("getCurrentTime" == a ? this[a] = function () { var a = this.j.currentTime; if (1 == this.j.playerState) { var b = (ha() / 1E3 - this.j.currentTimeLastUpdated_) * this.j.playbackRate; 0 < b && (a += Math.min(b, 1)) } return a } : Qb(a) ? this[a] = function () {
        this.j = {};
        this.i = {}; V(this, a, arguments); return this
  ...
  "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Eb(); var Zb = u("onYTReady"); Zb && Zb(); var $b = u("onYouTubeIframeAPIReady"); $b && $b(); var ac = u("onYouTubePlayerAPIReady"); ac && ac();
}).call(this);
